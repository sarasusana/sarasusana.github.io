...
<body>
  ...
  <main>
      ...
      <div><h1>Weather Report Confirmation</h1></div>
        <p>Thanks for informing us the weather events about in your travel area. We will be tracking the events previously detailed, and we will contact you if necessary.</p>
